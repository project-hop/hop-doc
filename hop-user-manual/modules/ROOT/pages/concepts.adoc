...
The link:hop-gui/environments/environments.adoc[Hop Environment] allows data developers to manage development, acceptance and production environments with their configurations and variables.
